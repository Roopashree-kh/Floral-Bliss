...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
   <?php
      $select_enquiries = mysqli_query($conn, "SELECT * FROM `enquiries`") or die('query failed');
      $number_of_enquiries = mysqli_num_rows($select_enquiries);
   ?>
   <h3><?php echo $number_of_enquiries; ?></h3>
   <p>total enquiries</p>
</div>
